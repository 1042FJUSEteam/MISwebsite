...
public class SchedulePlanDAOImpl implements SchedulePlanDAO{
	...
	public List<SchedulePlan> getSchedulePlanListU(){
		// TODO Auto-generated method stub
				...
				//String sqlU = "SELECT * FROM schedule_plan, plan WHERE schedule_plan.PLAN_CODE = plan.PLAN_CODE AND DIV_CODE='U' ORDER BY schedule_plan.YEAR DESC";
	...
	public List<SchedulePlan> getSchedulePlanListE(){
		// TODO Auto-generated method stub
				...
				//String sqlE = "SELECT * FROM schedule_plan, plan WHERE schedule_plan.PLAN_CODE = plan.PLAN_CODE AND DIV_CODE='E' ORDER BY schedule_plan .YEAR DESC";
