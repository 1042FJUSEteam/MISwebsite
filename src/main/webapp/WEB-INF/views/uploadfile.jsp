...
<body>
	...
	<div class="container">
		<br/>
		<form method="post" action="uploadfile" id="uploadfile" modelAttribute="uploadForm" enctype="multipart/form-data">
			<input type="hidden" name="di_code" id="di_code" value="${fileimintro.di_code}">
			<input type="hidden" name="dic_code" id="dic_code" value="${fileimintro.dic_code}">
