					...
					<tbody id="testt" >
						...
						<c:forEach items="${getAll}" var="getAll" >
							  	<tr class="category_${getAll.di_code} trrr"  style="display: none">
							  		...
							  		<td>
							  			<a class="btn btn-sm btn-danger deleteBtn" href="#" data-toggle="modal" data-target="#deleteModal" data-id="${getAll.di_code}" data-idc="${getAll.dic_code}">刪除</a>
							  		</td>
							  		<td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
	                <form id="deleteForm" action="deletedeptintro" method="post">
	            		...
	            		<input type="hidden" name="dic_code" id="dic_code">
